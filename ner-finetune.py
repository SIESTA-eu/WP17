...
class NERFineTuner:
    ...
    def train_manual(self, train_dataset, val_dataset, output_dir="./bert-ner-finetuned"):
    ...
    def train(self, train_dataset, val_dataset, output_dir="./bert-ner-finetuned"):
        """Fine-tune the model"""
...
def main():
    ...
    print("Model saved to ./bert-ner-finetuned")
...
get_ipython().system('rm -rf /home/meem/miniforge3/envs/text/lib/python3.9/site-packages/accelerate*')
get_ipython().system('rm -rf /home/meem/miniforge3/envs/text/lib/python3.9/site-packages/*accelerate*')
